...
<section id="edit">
<center>
   <h2 style="color: #234A83;">Update Organizational Data</h2>
  ...
  <?php
    ...
    $sql1 = "UPDATE organizational SET
      Org_name = '$name',
    Location = '$location', Established_date = '$date', Org_ownership = '$own', Org_type = '$type'
      WHERE
      Org_id = $id";
    ...
    if ($res1) {
     ...
     $sql = "SELECT * FROM organizational WHERE Org_id = $id";
  ...
  <form method='POST' action="">
    <table class='table table-hover table-responsive table-bordered'>
        <tr>
            ...
            <td> <input required type="text" class="form-control" name="orgname" value=<?php echo $row['Org_name']; ?>></td>
        </tr>
        <tr>
            <td>Location</td>
        ...
        <tr>
          ...
          <td>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="type" value="Hospital" required>
              <label class="form-check-label">Hospital</label>
            </div>
            <div class="form-check">
              <input required class="form-check-input" type="radio" name="type" value="School">
        ...
        <tr>
            ...
            <td>
                ...
                <a href='organizationaldata.php' class='btn btn-danger'>Back</a>
            </td>
        </tr>
    </table>
</form>
