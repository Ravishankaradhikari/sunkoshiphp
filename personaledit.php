...
<body>
  ...
  <section id="edit">
	<center>
   <h2 style="color: #234A83;">Update Personal Data</h2>
  ...
  <form method='POST' action="">
  	<table class='table table-hover table-responsive table-bordered'>
        <tr>
            <td>First Name</td>
            <td> <input required type="text" class="form-control" name="fname" value=<?php echo $row['First_name']; ?>></td>
        </tr>
        <tr>
            <td>Last Name</td>
            <td><input required type="text" class="form-control" name="lname" value=<?php echo $row['Last_name']; ?>></td>
        </tr>
        <tr>
            <td>Date of Birth</td>
            <td><input required type="Date" class="form-control" name="dob" value=<?php echo $row['Date_of_Birth']; ?>></td>
        </tr>
        <tr>
        	<td>Address</td>
        	<td><input required type="text" class="form-control" name="address" value=<?php echo $row['Address']; ?>></td>
        </tr>
        <tr>
        	<td>Gender:</td>
        	<td>
        ...
        <tr>
            ...
            <td>
                <input type='submit' value='Submit' class='btn btn-primary'>
      			<a href='personaldata.php' class='btn btn-danger'>Back</a>
            </td>
        </tr>
    </table>
</form>
