...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
  <table class="table table-bordered table-striped mb-0">
    <thead>
      <tr>
      <th scope="col">Industrial ID</th>
      <th scope="col">Industrial Name</th>
      <th scope="col">Location</th>
      <th scope="col">Established Date</th>
     <th scope="col">Industrial Type (Local/Mini/Micro)</th>
  ...
  <tbody>
    <?php foreach ($result as $value) {?>
      <tr>
        <th scope="row"><?php echo $value['Indus_id'];?></th>
        <td><?php echo $value['Indus_name'];?></td>
        <td><?php echo $value['Location'];?></td>
        <td><?php echo $value['Established_date'];?></td>
        <td><?php echo $value['Indus_type'];?></td>
        <td><a class="btn btn-primary" href="industrialedit.php?id=<?php echo $value['Indus_id']?>">Edit</a>
        <a class="btn btn-danger" href="industrialdelete.php?id=<?php echo $value['Indus_id']?>">Delete</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
