 ...
 <div class="table-wrapper-scroll-y my-custom-scrollbar">
  <table class="table table-bordered table-striped mb-0">
    <thead>
      ...
      <th scope="col">Ownership(Gov/Private)</th>
     <th scope="col">Org Type(School/Hospital)</th>
  ...
  <tbody> 
    <?php foreach ($result as $value) {?>
      <tr>
        <th scope="row"><?php echo $value['Org_id'];?></th>
        <td><?php echo $value['Org_name'];?></td>
        <td><?php echo $value['Location'];?></td>
        <td><?php echo $value['Established_date'];?></td>
        <td><?php echo $value['Org_ownership'];?></td>
        <td><?php echo $value['Org_type'];?></td>
        <td><a class="btn btn-primary" href="organizationaledit.php?id=<?php echo $value['Org_id']?>">Edit</a>
          <a class="btn btn-danger" href="organizationaldelete.php?id=<?php echo $value['Org_id']?>">Delete</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
