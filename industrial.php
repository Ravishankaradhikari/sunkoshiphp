...
<section id="industrial">
  <center>
    <h4 style="color: #234A83; ">Industry Details</h4>
    <?php
      if($_POST)
      {
        ...
        else
        {
          ...
          $rem ="INSERT INTO industrial( Indus_name, Location, Established_date, Indus_type) VALUES ('$indname', '$location', '$estdate', '$industype')";
              mysqli_query($con, $rem);
            echo '<p class=text-success>*Industrial Details Inserted Successfully</p>'; 
        } 
      }
    ?>
  <form action="" method="POST">
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="type" value="Mini">
          <label class="form-check-label">Mini</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="type" value="Micro">
